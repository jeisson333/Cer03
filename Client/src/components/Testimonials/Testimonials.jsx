...
const testimonialsData = [
    ...
    },
    {
        ...
        quote: 'Una plataforma excepcional para conectar con los demás en la comunidad.',
    },
    {
        id: 4,
        name: 'Ana Rodríguez',
        quote: 'Cer03 me ha ayudado a descubrir eventos interesantes y a conocer a personas increíbles.',
    },
    {
        id: 5,
        name: 'Pedro Sánchez',
        quote: 'Gran herramienta para fortalecer la comunidad y construir lazos significativos.',
    },
];
    ...
    return (
        <div className="max-w-3xl mx-auto mt-12 relative overflow-hidden">
            <div className="flex items-center">
                <button className="w-10 h-10 bg-gray-800 text-white flex items-center justify-center" onClick={handlePrev}>
                    {currentIndex === 0 ? '' : '<'}
                </button>
                ...
                <button className="w-10 h-10 bg-gray-800 text-white flex items-center justify-center" onClick={handleNext}>
