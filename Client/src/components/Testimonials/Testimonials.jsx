  ...
  return (
    <div className={Style.testimonialsContainer}>
      ...
      <div className={Style.buttonContainer}>
        <button className={Style.arrowButton} onClick={handlePrev} style={{ visibility: currentIndex === 0 ? 'hidden' : 'visible' }}>
          {'<'}
        </button>
        <button
          className={Style.arrowButton}
          onClick={handleNext}
          style={{ visibility: currentIndex * 2 + 2 < testimonialsData.length ? 'visible' : 'hidden' }}
        >
          {'>'}
        </button>
      </div>
