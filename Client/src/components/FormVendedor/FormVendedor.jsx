        ...
        switch (name) {
            ...
            case 'usuario':
                if (/^[A-Za-z0-9]+$/.test(value)) {
                    ...
                    nuevosErrores[name] = 'Ingrese un nombre de usuario válido (solo letras y números)';
                }
                break;
            case 'contraseña':
                if (value.length >= 6) {
                    ...
                    nuevosErrores[name] = 'La contraseña debe tener al menos 6 caracteres';
                }
                break;
            default:
                break;
    ...
    return (
        <form className={Style.formContainer} onSubmit={handleFormSubmit}>
            <div className={Style.container}>
                ...
                <input type="text" className={Style.formInput} name="primerNombre" value={form.primerNombre} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.primerNombre}</span>
                <br />

                <label className={Style.formLabel}>Segundo Nombre: </label>
                <input type="text" className={Style.formInput} name="segundoNombre" value={form.segundoNombre} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.segundoNombre}</span>
                <br />

                <label className={Style.formLabel}>Primer Apellido: </label>
                <input type="text" className={Style.formInput} name="primerApellido" value={form.primerApellido} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.primerApellido}</span>
                <br />

                <label className={Style.formLabel}>Segundo Apellido: </label>
                <input type="text" className={Style.formInput} name="segundoApellido" value={form.segundoApellido} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.segundoApellido}</span>
                <br />

                <label className={Style.formLabel}>Número de Documento: </label>
                <input type="text" className={Style.formInput} name="numeroDocumento" value={form.numeroDocumento} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.numeroDocumento}</span>
                <br />

                <label className={Style.formLabel}>Sucursal: </label>
                <input type="text" className={Style.formInput} name="sucursal" value={form.sucursal} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.sucursal}</span>
                <br />

                <label className={Style.formLabel}>Email: </label>
                <input type="text" className={Style.formInput} name="email" value={form.email} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.email}</span>
                <br />

                <label className={Style.formLabel}>Usuario: </label>
                <input type="text" className={Style.formInput} name="usuario" value={form.usuario} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.usuario}</span>
                <br />

                <label className={Style.formLabel}>Contraseña: </label>
                <input type="password" className={Style.formInput} name="contraseña" value={form.contraseña} onChange={handleInputChange} />
                <span className={Style.formError}>{errors.contraseña}</span>
                <br />

                <button type="submit" className={`${Style.formButton} ${Style.formSubmit}`} disabled={hayErrores()}>
                    Guardar
                </button>
            </div>
        </form>
